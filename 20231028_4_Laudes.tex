...
\ifcsname preamble@file\endcsname
  \setcounter{page}{\getpagerefnumber{M-20231028_4_Laudes}}
\fi

\begin{document}

\bigtitle{Saints Simon et Jude, apôtres --- Laudes}{forme extraordinaire}
...
\smalltitle{Capitule}
\twocoltext{Fratres: Jam non estis hóspites et ád\textit{venæ}: \pscross sed estis cives Sanctórum 
et doméstici Dei: superædificáti super fundaméntum Apostolórum, 
et \textit{Prophe}\textbf{tá}rum, \psstar ipso summo angulári lápide Christo Jesu.}{
Mes frères, vous n’êtes plus des hôtes et des étrangers, \pscross mais des concitoyens des saints 
et de la maison de Dieu ; bâtis sur le fondement des Apôtres et des Prophètes, \psstar 
...
\rr Et facta eius intellexérunt.}{
\vv Ils ont annoncé les œuvres de Dieu.\\
\rr Et ils ont compris les choses qu’il a faites.}

\smalltitle{Benedictus}
\gscore{APEXLAB}
\translation{\aarub Vous qui avez tout quitté et qui m’avez suivi, vous recevrez le centuple et vous posséderez la vie éternelle.}
\psalm{ben}{1}
