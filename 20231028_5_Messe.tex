...
\vv \rubrique{\emph{1. }} Tu me scrutes, Seigneur, et tu sais ! Tu sais quand je m'assois, quand je me lève.\\
\vv \rubrique{\emph{2. }} De très loin, tu pénètres mes pensées: que je marche ou me repose, tu le vois.\\
\vv \rubrique{\emph{3. }} Tous mes chemins te sont familiers, avant qu'un mot ne parvienne à mes lèvres.}
...
\emph{Alléluia, alléluia. Tes amis ont été honorés, ô Dieu ; leur dignité de princes a été puissamment établie. Alléluia.}
...
\gscore{1028Co}
\translation{\rubrique{Mt. 19: 28; Ps. 125: 1-4} Vous qui m’avez suivi, vous siégerez sur douze trônes pour juger les douze tribus d’Israël.\\
\vv \rubrique{\emph{1. }} Quand le Seigneur ramena les captifs à Sion, nous étions comme en rêve.\\
\vv \rubrique{\emph{2a. }} Alors notre bouche était pleine de rires, nous poussions des cris de joie.\\
\vv \rubrique{\emph{2b. }} Alors on disait parmi les nations : « Quelles merveilles fait pour eux le Seigneur ! »\\
\vv \rubrique{\emph{3. }} Quelles merveilles le Seigneur fit pour nous : nous étions en grande fête.\\
\vv \rubrique{\emph{4. }} Ramène, Seigneur, nos captifs, comme les torrents au désert.
}
